package com.example.uniqueweather;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void search(View view){
        ...
        try {
            content = weather.execute("https://api.openweathermap.org/data/2.5/weather?q="+cName+"&appid=4504a99423b03245a2123ce6e13803ff").get();
